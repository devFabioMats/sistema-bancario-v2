...
import static controller.InvestimentoControle.password;
import static controller.InvestimentoControle.url;
import static controller.InvestimentoControle.user;
...
public class RecargaControle {
    ...
    public void recarregar(int login, String senha, float valor, Conta conta){
        ...
        try{
            ...
            rs.setFloat(1, valor);
            rs.setString(2, "Recarga de Creditos");
