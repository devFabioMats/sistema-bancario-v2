...
public class ViewRecarga extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lTelefone.setFont(new java.awt.Font("Segoe UI", 0, 14));
        lTelefone.setText("Insira seu celular");

        btRecarga.setFont(new java.awt.Font("Segoe UI", 0, 14));
        ...
        btVoltar.setFont(new java.awt.Font("Segoe UI", 0, 14));
    ...
    private void jcValorActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void btRecargaActionPerformed(java.awt.event.ActionEvent evt) {
        try{
